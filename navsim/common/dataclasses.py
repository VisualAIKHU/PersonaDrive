...
class Scene:
    ...
    def get_agent_input_uc(self, uc) -> AgentInput:
        """
        ...
        agent_input.bert_feature = uc["bert_feature"]
        agent_input.attention_mask = uc["attention_mask"]
        return agent_input
...
class PDMResults:
    ...
    # Raw Centerline Progress (meters, no collision penalty)
    progress_raw: float = 0.0
    # Route Completion Ratio: min(1, agent_progress / expert_progress)
